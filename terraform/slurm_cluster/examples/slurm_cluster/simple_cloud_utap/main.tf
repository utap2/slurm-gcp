...
locals {
  ...
  controller_instance_config = {
    ...
    source_image         = "projects/PROJECT_ID/global/images/utap-controller-slurm-simple-final"
  ...
  login_nodes = [
    {
      ...
      #source_image_project = local.source_image_project
      #source_image_family  = local.source_image_family
      source_image         = "projects/PROJECT_ID/global/images/utap-login-slurm-simple-final"
